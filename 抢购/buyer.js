...
const config = {
    user: '18660653953', // WARNING: if you using phone number to login, make sure the phone number and your network(maybe proxy) in the same nation
    password: 'fs54264546',
    itemlink: 'https://item.mi.com/product/8625.html', // For example: "https://item.mi.com/product/9372.html" - Mi9Pro
    thetime: 1563257580 // https://shijianchuo.911cha.com/ helps you convert string to timestamp
}
